...
// path.Expression are true if the current attribute value is configured (non-null),
// regardless of whether the object's own attributes are set.
...
func RequiresTrueIfConfigured(expressions ...path.Expression) validator.Object {
