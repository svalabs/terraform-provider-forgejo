...
resource "forgejo_repository" "test" {
	name = "tftest"
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("forgejo_repository.test", tfjsonpath.New("allow_fast_forward_only_merge"), knownvalue.Bool(false)),
					statecheck.ExpectKnownValue("forgejo_repository.test", tfjsonpath.New("allow_rebase_update"), knownvalue.Bool(true)),
					statecheck.ExpectKnownValue("forgejo_repository.test", tfjsonpath.New("default_allow_maintainer_edit"), knownvalue.Bool(false)),
