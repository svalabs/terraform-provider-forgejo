...
`,
			...
			{
				Config: providerConfig + `
resource "forgejo_repository" "test_mirror_develop" {
...
`,
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("allow_merge_commits"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("allow_rebase_explicit"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("allow_rebase"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("allow_squash_merge"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("archived"), knownvalue.Bool(false)),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("auto_init"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("avatar_url"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("clone_addr"), knownvalue.StringExact("https://github.com/acch/test-non-default-branch")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("clone_url"), knownvalue.StringExact("http://localhost:3000/tfadmin/tftest-mirror-develop.git")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("created_at"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("default_branch"), knownvalue.StringExact("develop")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("default_merge_style"), knownvalue.StringExact("merge")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("description"), knownvalue.StringExact("Purely for testing...")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("empty"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("external_tracker"), knownvalue.Null()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("external_wiki"), knownvalue.Null()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("fork"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("forks_count"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("full_name"), knownvalue.StringExact("tfadmin/tftest-mirror-develop")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("gitignores"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("has_actions"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("has_issues"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("has_packages"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("has_projects"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("has_pull_requests"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("has_releases"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("has_wiki"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("html_url"), knownvalue.StringExact("http://localhost:3000/tfadmin/tftest-mirror-develop")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("id"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("ignore_whitespace_conflicts"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("internal_tracker"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("internal"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("issue_labels"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("license"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("mirror_interval"), knownvalue.StringExact("12h0m0s")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("mirror_updated"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("mirror"), knownvalue.Bool(true)),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("name"), knownvalue.StringExact("tftest-mirror-develop")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("open_issues_count"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("open_pr_counter"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("owner"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("parent_id"), knownvalue.Null()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("permissions"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("private"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("readme"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("release_counter"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("size"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("ssh_url"), knownvalue.StringExact("ssh://git@localhost:2222/tfadmin/tftest-mirror-develop.git")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("stars_count"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("template"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("trust_model"), knownvalue.StringExact("default")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("updated_at"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("watchers_count"), knownvalue.Int64Exact(1)),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("website"), knownvalue.StringExact("")),
				},
			},
...
`,
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("clone_url"), knownvalue.StringExact("http://localhost:3000/tfadmin/tftest-mirror-develop.git")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("created_at"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("default_branch"), knownvalue.StringExact("production")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("default_merge_style"), knownvalue.StringExact("merge")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("description"), knownvalue.StringExact("Purely for testing...")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("empty"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("external_tracker"), knownvalue.Null()),
					...
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("issue_labels"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("license"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("mirror_interval"), knownvalue.StringExact("24h0m0s")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("mirror_updated"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("mirror"), knownvalue.Bool(true)),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("name"), knownvalue.StringExact("tftest-mirror-develop")),
					statecheck.ExpectKnownValue("forgejo_repository.test_mirror_develop", tfjsonpath.New("open_issues_count"), knownvalue.Int64Exact(0)),
