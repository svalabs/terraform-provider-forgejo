	...
	units_map = {
		"repo.issues" = "read"
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("forgejo_team.test_by_name", tfjsonpath.New("organization_id"), knownvalue.Int64Exact(0)),
...
resource "forgejo_team" "test_by_name2" {
	...
	units_map = {
		"repo.issues" = "read"
			...
			// Import testing
			{
				ResourceName:            "forgejo_team.test_by_id",
				ImportState:             true,
				ImportStateId:           "team_test_org/test_team_by_id",
				ImportStateVerify:       true,
	...
	units_map = {
		"repo.code" = "read"
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("forgejo_team.test_by_name[99]", tfjsonpath.New("organization_id"), knownvalue.Int64Exact(0)),
