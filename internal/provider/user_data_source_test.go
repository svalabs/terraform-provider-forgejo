...
data "forgejo_user" "test" {
  login = "test_user_1"
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue(
						"data.forgejo_user.test",
						tfjsonpath.New("followers_count"),
						knownvalue.NotNull(),
					),
					statecheck.ExpectKnownValue(
						"data.forgejo_user.test",
						tfjsonpath.New("following_count"),
						knownvalue.NotNull(),
					),
					statecheck.ExpectKnownValue(
						"data.forgejo_user.test",
					...
					statecheck.ExpectKnownValue(
						...
						knownvalue.StringExact("test_user_1"),
					),
					statecheck.ExpectKnownValue(
						"data.forgejo_user.test",
						tfjsonpath.New("login_name"),
						knownvalue.NotNull(),
					),
					statecheck.ExpectKnownValue(
						"data.forgejo_user.test",
						tfjsonpath.New("prohibit_login"),
						knownvalue.NotNull(),
					),
					statecheck.ExpectKnownValue(
						"data.forgejo_user.test",
						tfjsonpath.New("restricted"),
						knownvalue.NotNull(),
					),
					statecheck.ExpectKnownValue(
						"data.forgejo_user.test",
					...
					statecheck.ExpectKnownValue(
						"data.forgejo_user.test",
						tfjsonpath.New("starred_repos_count"),
						knownvalue.NotNull(),
					),
					statecheck.ExpectKnownValue(
						"data.forgejo_user.test",
