...
data "forgejo_team_membership" "test" {
	...
	user_id = 1011
				...
				ExpectError: regexp.MustCompile("no Team with id '1011' was found"),
			},
...
data "forgejo_team_membership" "test" {
	...
	user_id = 1011
				...
				ExpectError: regexp.MustCompile("no User with id '1011' was found"),
			},
...
data "forgejo_team_membership" "test" {
	...
	user_id = forgejo_user.test.id
				...
				ExpectError: regexp.MustCompile("the user 'test_user' is not a member of team with ID '"),
			},
			// Read testing
			{
				Config: providerConfig + `
