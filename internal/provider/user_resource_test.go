...
resource "forgejo_user" "test" {
	...
	password = "passw0rd"
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("avatar_url"), knownvalue.StringRegexp(regexp.MustCompile("^"+forgejoTestHost+"/avatars/[0-9a-z]{32}$"))),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("created_at"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("deactivate_on_destroy"), knownvalue.Bool(false)),
					...
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("html_url"), knownvalue.StringExact(forgejoTestHost+"/tftest")),
...
resource "forgejo_user" "test" {
	...
	password = "passw1rd"
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("following_count"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("full_name"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("html_url"), knownvalue.StringExact(forgejoTestHost+"/tftest1")),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("id"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("language"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("last_login"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("location"), knownvalue.StringExact("")),
...
resource "forgejo_user" "test" {
	...
	website              = "` + forgejoTestHost + `"
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("website"), knownvalue.StringExact(forgejoTestHost)),
					statecheck.ExpectSensitiveValue("forgejo_user.test", tfjsonpath.New("password")),
				},
			},
			// Update and Read testing
...
resource "forgejo_user" "test" {
	...
	password                  = "passw1rd"
			...
			// Deactivate on destroy testing -- creation/updating
			{
				Config: providerConfig + `
resource "forgejo_user" "test" {
	login                 = "tftest1"
	...
	deactivate_on_destroy = true
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("avatar_url"), knownvalue.StringRegexp(regexp.MustCompile("^"+forgejoTestHost+"/avatars/[0-9a-z]{32}$"))),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("created_at"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("deactivate_on_destroy"), knownvalue.Bool(true)),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("description"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("email"), knownvalue.StringRegexp(regexp.MustCompile(`^[0-9a-z]+@[a-z]+\.[a-z]+$`))),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("followers_count"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("forgejo_user.test", tfjsonpath.New("following_count"), knownvalue.Int64Exact(0)),
...
data "forgejo_user" "test" {
	login = "tftest1"
				...
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("active"), knownvalue.Bool(false)),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("admin"), knownvalue.Bool(false)),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("avatar_url"), knownvalue.StringRegexp(regexp.MustCompile("^"+forgejoTestHost+"/avatars/[0-9a-z]{32}$"))),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("created_at"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("description"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("email"), knownvalue.StringRegexp(regexp.MustCompile(`^[0-9a-z]+@[a-z]+\.[a-z]+$`))),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("followers_count"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("following_count"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("full_name"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("html_url"), knownvalue.StringExact(forgejoTestHost+"/tftest1")),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("id"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("language"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("last_login"), knownvalue.NotNull()),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("location"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("login_name"), knownvalue.StringExact("")),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("login"), knownvalue.StringExact("tftest1")),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("prohibit_login"), knownvalue.Bool(false)),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("restricted"), knownvalue.Bool(false)),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("source_id"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("starred_repos_count"), knownvalue.Int64Exact(0)),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("visibility"), knownvalue.StringExact("private")),
					statecheck.ExpectKnownValue("data.forgejo_user.test", tfjsonpath.New("website"), knownvalue.StringExact("")),
				},
			},
			// Deactivate on destroy testing -- importing reactivates
			{
				Config: providerConfig + `
resource "forgejo_user" "test" {
	login                 = "tftest1"
