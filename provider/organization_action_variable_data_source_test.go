...
data "forgejo_organization_action_variable" "test" {
	...
	name         = "my_variable"
				...
				ExpectError: regexp.MustCompile(`Action variable with organization "non-existent" and name "my_variable" not
found`),
			},
...
data "forgejo_organization_action_variable" "test" {
	...
	name            = "my_variable"
				...
				ExpectError: regexp.MustCompile(`Action variable with organization "test_org" and name "my_variable" not
found`),
			},
