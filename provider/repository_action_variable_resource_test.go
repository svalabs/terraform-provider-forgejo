	...
	data          = "my_variable_value"
				...
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectResourceAction("forgejo_repository_action_variable.test", plancheck.ResourceActionCreate),
					},
				},
...
resource "forgejo_repository_action_variable" "duplicate" {
	repository_id = forgejo_repository.test.id
	name          = "my_variable"
...
resource "forgejo_repository_action_variable" "test" {
	...
	data          = "my_variable_value"
				...
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectResourceAction("forgejo_repository_action_variable.test", plancheck.ResourceActionUpdate),
					},
				},
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("forgejo_repository_action_variable.test", tfjsonpath.New("repository_id"), knownvalue.NotNull()),
